...
class ProfileVC: MainTabBarItemVC {
    ...
    private lazy var recomendationButton: DTSystemButton = {
        let button = DTSystemButton(tittle: "Recomendations")
    ...
    private lazy var statisticButton: DTSystemButton = {
        let button = DTSystemButton(tittle: "Statistic")
    ...
    private lazy var settingButton: DTSystemButton = {
        let button = DTSystemButton(tittle: "Setting")
    ...
    private lazy var signOutButton: DTSystemButton = {
        let button = DTSystemButton(tittle: "Sign out")
